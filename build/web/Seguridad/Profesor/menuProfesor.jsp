...
%>
<%   
objProfBean=(ProfesorBean)request.getAttribute("admin");
%>
<html lang="en" >
<head>
...
<body class="off-canvas" onload="ingresarmenu('<%= objProfBean.getIdprofesor()%>'),cargar_promedio('<%=request.getContextPath()%>','Profesor',8,'cod=<%=objProfBean.getCodigoprofesor()%>'),cargarinactividad()">
    <div id="container"style="position: relative">
        <header id="header">
            <!--logo start-->
            <div class="brand">
                <a href="javascript:cargar_promedio('<%=request.getContextPath()%>','Profesor',8,'cod=<%=objProfBean.getCodigoprofesor() %>')" class="logo"><span>PROFESOR</span></a>
            </div>
            <!--logo end-->
                ...
                <ul>
                    ...
                    <li class="dropdown settings">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                         <%=objProfBean.getIdprofesor()%>  <i class="fa fa-angle-down"></i>
                     </a>
        ...
        <ul class="nav nav-pills nav-stacked">
            <li class="active">
                <a href="#" title="Dashboard">
                    <i class="fa fa-user"></i><%=objProfBean.getIdprofesor()%> 
                </a>
            </li>
            ...
            <li class="nav-dropdown">
                ...
                <ul class="nav-sub">
                    ...
                    <li><a href="javascript:Menu('<%=request.getContextPath()%>','Examen',1,'cod='+ <%=objProfBean.getCodigoprofesor()%>  )">Crear Examen</a>
                    </li>
                    <li><a href="javascript:Menu('<%=request.getContextPath()%>','Estu',4,'cod='+ <%=objProfBean.getCodigoprofesor()%>  )">Revisar Examenes</a>
                    </li>
                    <li><a href="javascript:cargar('<%=request.getContextPath()%>','Notas',1,'cod='+ <%=objProfBean.getCodigoprofesor()%>   )">Notas Alumnos</a>
                    </li>
                </ul>
            </li>
