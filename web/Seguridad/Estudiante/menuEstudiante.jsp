...
<%!
AlumnoBean objUsuBean = new AlumnoBean();
%>
<%   
objUsuBean=(AlumnoBean)request.getAttribute("estudiante");
%>
<html lang="en" >
<head>
...
<body class="off-canvas" onload="ingresarmenu('<%= objUsuBean.getIdalumno()%>'),cargar_promedio('<%=request.getContextPath()%>','Estu',28,'cod=<%=objUsuBean.getCodalumno()%>'),cargarinactividad()">
    <div id="container" style="position: relative">
        
        <header id="header">
            <!--logo start-->
            <div class="brand">
                <a href="javascript:cargar_promedio('<%=request.getContextPath()%>','Estu',28,'cod=<%=objUsuBean.getCodalumno()%>')" class="logo"><span>ESTUDIANTE</span></a>
            </div>
            <!--logo end-->
                ...
                <ul>
                    ...
                    <li class="dropdown settings">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                           <%=objUsuBean.getIdalumno()%>  <i class="fa fa-angle-down"></i>
                       </a>
        ...
        <ul class="nav nav-pills nav-stacked">
            <li class="active">
                <a href="#" title="Dashboard">
                    <i class="fa fa-user"></i><%=objUsuBean.getIdalumno()%>
                </a>
            </li>

            <li class="nav-dropdown">
                <a href="#" title="Tables">
                    <i class="fa fa-table"></i> Examenes
                </a>
                <ul class="nav-sub">
                    <li><a href="javascript:Menu('<%=request.getContextPath()%>','Estu',5,'cod=<%=objUsuBean.getCodalumno()%>')">Faltantes</a>
                    </li>
            ...
            <li class="nav-dropdown">
                <a href="#" title="Mail">
                    <i class="fa fa-table"></i> Notas
                </a>
                <ul class="nav-sub">
                    <li><a href="javascript:Menu('<%=request.getContextPath()%>','Estu',8,'cod=<%=objUsuBean.getCodalumno()%>')">Promedio</a>
                    </li>
